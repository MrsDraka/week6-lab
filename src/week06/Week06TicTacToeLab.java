...
public class Week06TicTacToeLab {
	...
	public static HashMap<Integer,String> newGame(){
		
		HashMap<Integer, String> gameBoard = new HashMap<Integer, String>();
	...
	public static HashMap<Integer, String> boardUpdate(String turn, Integer spot, HashMap<Integer, String> board) {
	...
	public static void displayBoard(HashMap<Integer, String> board) {
	...
	public static boolean isGameOver(HashMap<Integer, String> board, int numTurn) {
		...
		if (board.get(3).equals("X") && board.get(6).equals("X") && board.get(9).equals("X")) {
			return true;
		}
		...
		if (board.get(4).equals("X") && board.get(5).equals("X") && board.get(6).equals("X")) {
			return true;
		}
		if (board.get(7).equals("X") && board.get(8).equals("X") && board.get(9).equals("X")) {
			return true;
		}
		if (board.get(1).equals("X") && board.get(5).equals("X") && board.get(9).equals("X")) {
			return true;
		}
		if (board.get(3).equals("X") && board.get(5).equals("X") && board.get(7).equals("X")) {
			return true;
		}
		...
		if (board.get(3).equals("O") && board.get(6).equals("O") && board.get(9).equals("O")) {
			return true;
		}
		
		if (board.get(1).equals("O") && board.get(2).equals("O") && board.get(3).equals("O")) {
			return true;
		}
		
		if (board.get(4).equals("O") && board.get(5).equals("O") && board.get(6).equals("O")) {
			return true;
		}
		if (board.get(7).equals("O") && board.get(8).equals("O") && board.get(9).equals("O")) {
			return true;
		}
		if (board.get(1).equals("O") && board.get(5).equals("O") && board.get(9).equals("O")) {
			return true;
		}
		if (board.get(3).equals("O") && board.get(5).equals("O") && board.get(7).equals("O")) {
			return true;
		}
	...
	public static void main(String[] args) {
		...
		while (playGame == 1) {
			...
			if (newGame == 1) {
				...
				System.out.println("+---+---+---+");
				System.out.println("In this game X goes first.");
				System.out.println("To place your marker, please input the number of the square you want: ");
				
				HashMap<Integer, String> gameBoard = newGame();
				
				int choice = getChoice();
				
				
				if (choice >= 1 && choice <=9) {
					boardUpdate(turn, choice, gameBoard);
				...
				while (numTurn <=9) {
					...
					if (numTurn >= 5) {
						...
						boolean wonGame = isGameOver(gameBoard, numTurn);
					...
					System.out.println("Please input the number of the square you want: ");
					choice = getChoice();
					boardUpdate(turn, choice, gameBoard);
					displayBoard(gameBoard);
